//
//  SearchDatabaseViewController.swift
//  MyRecruits
//
...
class DatabaseWebViewController: UIViewController {

    @IBOutlet var webView: UIWebView!
    var searchName = ""
    override func viewDidLoad() {
        super.viewDidLoad()
        //self.title = recentMovieName
        
        let searchNameNoSpaces = searchName.stringByReplacingOccurrencesOfString(" ", withString: "+")
        
        let websiteURL = "http://perfectgame.org/Search.aspx?search=" + searchNameNoSpaces
